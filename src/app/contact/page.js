...
export default function ContactPage() {
  ...
  return (
    <>
      <main className="min-h-screen bg-[#fcbebe] text-white tracking-widest flex flex-col px-6 py-10">

        {/* Header */}
        <h1 className="text-3xl md:text-4xl uppercase heading-font text-[#fa5555] tracking-widest text-center mb-6">
          Contact Us
        </h1>
        ...
        <div className="flex flex-col items-center w-full">
          ...
          <div className="text-center mt-20">
            <p className="text-[#fa5555] text-2xl md:text-4xl heading-font tracking-widest uppercase">
              Behind the Saddle
            </p>
            <p className="text-white underline underline-offset-4 text-lg md:text-2xl mt-2 ">
              <a
                href="mailto:Behindthesaddle25@gmail.com"
                className="underline uppercase hover:text-[#fa5555] transition-colors"
              >
